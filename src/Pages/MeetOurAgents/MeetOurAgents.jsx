    ...
    return (
        <div className="max-w-screen-xl mx-auto px-2 md:px-10 lg:px-20">
            <div className="lg:w-1/2 mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold">Meet Our Agents</h2>
                <p className="text-black mt-2">Meet our agents, dedicated experts in the world of real estate, each equipped with a wealth of knowledge to guide you through your property journey.</p>
            </div>
